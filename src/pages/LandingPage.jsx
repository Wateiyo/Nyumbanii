        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow text-center">
              ...
              <h3 className="text-2xl font-semibold text-gray-900 mb-3">Centralized Control</h3>
              <p className="text-gray-600">Manage all properties, tenants, and operations from one powerful dashboard.</p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow text-center">
              ...
              <h3 className="text-2xl font-semibold text-gray-900 mb-3">Save 10+ Hours/Week</h3>
              <p className="text-gray-600">Automate rent collection, maintenance tracking, and tenant communication.</p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow text-center">
              ...
              <h3 className="text-2xl font-semibold text-gray-900 mb-3">Reduce Costs by 40%</h3>
              <p className="text-gray-600">Cut operational costs with automated workflows and efficient management.</p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow text-center">
              ...
              <h3 className="text-2xl font-semibold text-gray-900 mb-3">Real-Time Alerts</h3>
              <p className="text-gray-600">Stay informed with instant notifications for maintenance, payments, and requests.</p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow text-center">
              ...
              <p className="text-gray-600">Bank-level security with automated backups to keep your data safe.</p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow text-center">
              ...
              <h3 className="text-2xl font-semibold text-gray-900 mb-3">Better Communication</h3>
              <p className="text-gray-600">Bridge the gap between landlords and tenants with seamless messaging.</p>
            </div>
          </div>
        </div>
      </section>
