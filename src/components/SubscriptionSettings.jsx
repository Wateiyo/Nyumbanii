  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center py-12">
        <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#003366] dark:border-blue-500"></div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
        <div className="bg-gradient-to-r from-[#003366] to-[#004488] dark:from-blue-700 dark:to-blue-800 px-6 py-4">
                ...
                <div className="flex justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <statusInfo.icon className={`h-5 w-5 ${
                      ...
                      statusInfo.color === 'red' ? 'text-red-500 dark:text-red-400' :
              ...
              <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                {paymentHistory.map((payment) => (
                  <tr key={payment.id}>
                    ...
                    <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-300 capitalize">
                      {payment.plan || 'N/A'}
                    </td>
